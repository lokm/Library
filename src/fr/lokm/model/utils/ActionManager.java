...
public final class ActionManager  { //final pour que personne puisse la modifier et personne la prenne en heritage
    ...
    static {
        ...
        actions.put(FrontServlet.ACTION_ADDAUTHOR, new AddAuthor());
		...
		actions.put(FrontServlet.ACTION_SIGNIN, new SigninAction());
		actions.put(FrontServlet.ACTION_LOGOUT, new LogoutAction());
		actions.put(FrontServlet.ACTION_LOGIN, new LoginAction());
